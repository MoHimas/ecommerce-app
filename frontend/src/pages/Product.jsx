      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            doloribus maiores eaque soluta odit ad excepturi hic mollitia
            veritatis voluptates consequuntur culpa est esse dicta qui enim,
            perferendis saepe laborum?
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias
            harum quod fugiat, minus repellat blanditiis cupiditate ut animi
            distinctio aspernatur? Sit sequi quisquam a aut expedita labore iure
            aperiam dolorem!
          </p>
        </div>
      </div>
